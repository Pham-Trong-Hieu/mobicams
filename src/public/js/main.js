      ...
      for (let j = 0; j < images.length; j++) {
        htmlContent += `
          <div class="owl-carousel-img">
            <img loading="lazy"   decoding="asynchronous"
...
//   <img loading="lazy"   decoding="asynchronous" src="${item.thumb}" alt="mobicam-lợi ích của khách hàng" class="d-none">
